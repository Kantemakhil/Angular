...
export class OffenderExternalMovements extends BaseModel {
    ...
    private _newBookingFlag:boolean;
    ...
    set birthDate(pbirthDate: Date) { this._birthDate = pbirthDate; }s
    ...
    get newBookingFlag(): boolean { return this._newBookingFlag; }
    set newBookingFlag( pnewBookingFlag: boolean ) { this._newBookingFlag = pnewBookingFlag; }
    ...
    toJSON(): any {
        return {
            ...
            'newBookingFlag':this._newBookingFlag,
