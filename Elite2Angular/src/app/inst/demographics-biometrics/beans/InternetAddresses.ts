...
export class InternetAddresses extends BaseModel {
    ...
    private _emailTo: boolean;
    private _emailCc: boolean;
    private _emailBcc: boolean;

    get emailTo(): boolean { return this._emailTo; }

    set emailTo(pemailTo: boolean) { this._emailTo = pemailTo; }

    get emailCc(): boolean { return this._emailCc; }

    set emailCc(pemailCc: boolean) { this._emailCc = pemailCc; }

    get emailBcc(): boolean { return this._emailBcc; }

    set emailBcc(pemailBcc: boolean) { this._emailBcc = pemailBcc; }

    get returnAddress(): string { return this._returnAddress; }

    set returnAddress(preturnAddress: string) { this._returnAddress = preturnAddress; }
    ...
    toJSON(): any {
        return {
            ...
            'emailCc': this._emailCc,
            'emailBcc': this._emailBcc
        };
    }
}
