...
export class VOffenderEducationAddresses extends BaseModel {
    ...
    private _streetIinformation: string;
...
set addressTypeDbCode( paddressTypeDbCode: string ) { this._addressTypeDbCode = paddressTypeDbCode; }
    ...
    get streetIinformation(): string { return this._streetIinformation; }

    set streetIinformation( pstreetIinformation: string ) { this._streetIinformation = pstreetIinformation; }
    ...
    toJSON(): any {
        return {
            ...
            'streetIinformation': this._streetIinformation,
