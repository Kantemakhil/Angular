...
@Component({
  selector: 'app-ocuoicap',
  templateUrl: './ocuoicap.component.html',
  styleUrls: ['./ocuoicap.component.css']
})
export class OcuoicapComponent implements OnInit {
