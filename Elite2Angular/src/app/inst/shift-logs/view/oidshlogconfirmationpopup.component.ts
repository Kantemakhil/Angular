...
@Component({
    selector: 'app-oidshlogconfirmationpopup',
    templateUrl: './oidshlogconfirmationpopup.component.html'
})

export class OidshlogconfirmationpopupComponent implements OnInit {
