...
export class ProsmainService {
	...
	processBulkCommit(obj) {
		return this.http.post('prosmain/processBulkCommit', obj);
	}
	deployeBpmn(obj) {
	...
	validateBulkDeploy(data: any) {
		return this.http.post('cmdwork/validateBulkDeploy', data);
	}
	deleteTrigger(triggerId: any) {
		return this.http.post('cmdwork/deleteTrigger', triggerId);
	}
	deleteBulkTrigger(data : any) {
		return this.http.post('cmdwork/deleteBulkTrigger', data);
	}
	...
	deployProcesses(list) {
		return this.http.post('prosmain/deployBulkProcesses', list);
	}
