...
export class VPropertyHeaderBlock extends BaseModel {
 ...
 private _activeFlag: string;
    ...
    private _image: any;
    private _pptyAgyLocId: string;

    get pptyAgyLocId(): string { return this._pptyAgyLocId; }

    set pptyAgyLocId(ppptyAgyLocId: string){ this._pptyAgyLocId = ppptyAgyLocId; }
    ...
    toJSON(): any {
        return {
            ...
            'suffix': this._suffix,
            'image': this._image,
            'pptyAgyLocId': this._pptyAgyLocId
        };
    }
}
